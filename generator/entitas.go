...
//
// Entitas-Go: github.com/dudareviv/Entitas-Go
//
//////////////////////////////////////////////////////////////////////////
package ecs
`
...
var files []string = []string{
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/entityPool.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/component.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/componentBitSet.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/componentPool.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/events.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/contexts.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/entity.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/entityBase.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/matcher.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/group.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/collector.go",
	"https://raw.githubusercontent.com/dudareviv/Entitas-Go/master/ecs/system.go",
}
...
func CreateEntitasContextFile(context string, components []*Component, src []byte) {
	...
	for i, v := range components {
		...
		contextData = strings.Replace(contextData, "//go:generate go run github.com/dudareviv/Entitas-Go", "", -1)
		if i == 0 {
